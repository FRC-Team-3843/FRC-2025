# FRC-2025 Repository - Claude Configuration

## How to Use This Configuration

This file is for Claude-specific behavior when working in the FRC-2025 repository.
...
- **Documentation:** When explaining code, reference specific line numbers (e.g., `SwerveSubsystem.java:45`).
