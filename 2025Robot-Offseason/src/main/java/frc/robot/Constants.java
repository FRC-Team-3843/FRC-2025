...
//  }
  ...
  public static class ArmConstants{  // Same as elevator
    public static final int MOTOR_ID = 33;

    public static final double STOWED_POS = 5;
    public static final double L1_POS = 10; 
    public static final double L2_POS = 10; 
    public static final double L3_POS = 10; 
    public static final double L4_POS = 10;
  ...
  public static class HandConstants{
    ...
    public static final double INTAKE_SPEED = 0.25; // Change the value to whatever seems correct. 0-1
    public static final double OUTTAKE_SPEED = 0.25; // Change the value to whatever seems correct. 0-1

    public static InvertedValue HAND_MOTOR_INVERT = InvertedValue.Clockwise_Positive;
  }

  public static class WristConstants{
    public static final int SERVO_CHANNEL = 0; // Change to whatever channel this in pluged into.

    public static final double WRIST_MIN_ANGLE = 0.0;
    public static final double WRIST_MAX_ANGLE = 200.0;
  }

  /* Just in case you want to look at these.
